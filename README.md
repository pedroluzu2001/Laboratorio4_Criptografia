...
|5|Next using this public key file, send Bill<br> (w.buchanan@napier.ac.uk) an encrypted question<br>(http://asecuritysite.com/public.txt).|Did you receive a reply:|
